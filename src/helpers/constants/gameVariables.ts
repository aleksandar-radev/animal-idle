...
export const CHARACTER_SKILL_DOUBLE_DAMAGE = 'doubleDamage';
export const CHARACTER_SKILL_AUTO_CAST = 'autoCast';
...
// ATTACK SKILLS
export const DAMAGE_FLAT = 'damageFlat';
export const DAMAGE_PERCENT = 'damagePercent';
export const CRIT_CHANCE = 'critChance';
export const CRIT_DAMAGE = 'critDamage';
export const ATTACK_SPEED = 'attackSpeed';
export const DOUBLE_DAMAGE_CHANCE = 'doubleDamageChance';

// DEFENSE SKILLS
export const BONUS_HEALTH = 'bonusHealth';
export const BONUS_DEFENSE = 'bonusDefense';

// UTILITY SKILLS
export const BONUS_GOLD = 'bonusGold';

// IMAGES / ASSETS
export const BARBARIAN_AVATAR = ENEMY_TYPE_BARBARIAN;
export const SORCERESS_AVATAR = ENEMY_TYPE_SORCERESS;
export const ASSASSIN_AVATAR = ENEMY_TYPE_ASSASSIN;
export const WARRIOR_AVATAR = ENEMY_TYPE_WARRIOR;

export const ATTACK_SKILL_IMG = CHARACTER_SKILL_ATTACK;
export const HEAL_SKILL_IMG = CHARACTER_SKILL_HEAL;
